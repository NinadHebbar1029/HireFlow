...
import { FaEnvelope, FaEnvelopeOpen, FaPaperPlane, FaPlus, FaTimes, FaSearch, FaInbox, FaUser, FaClock, FaCheckCircle, FaReply, FaTrash, FaStar, FaCircle } from 'react-icons/fa';
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-4 text-white/90">
                              ...
                              <div className="flex items-center gap-2 px-3 py-1.5 bg-white/20 backdrop-blur-sm rounded-lg">
                                ...
                                <span className="text-sm">{new Date(selectedMessage.sent_at).toLocaleString()}</span>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-blue-100">Send a message to a recruiter</p>
                        </div>
                      </div>
                      <motion.button
